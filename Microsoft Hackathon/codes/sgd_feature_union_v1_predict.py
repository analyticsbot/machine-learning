...
pipeline = Pipeline([
    ...
    ('union', FeatureUnion(
        transformer_list=[
            ...
            ('title', Pipeline([
                ...
                ('tfidf', TfidfVectorizer(norm='l1', max_df = 0.7, ngram_range= (1, 3))),
    ...
    ('clf', SGDClassifier(alpha = 1e-17, n_iter = 5, verbose =0, penalty = 'l2')),
])
...
if __name__ == "__main__":
    ...
    df['topic'] = predicted
    df.to_csv('challenge1_output_topic_4_.csv')
