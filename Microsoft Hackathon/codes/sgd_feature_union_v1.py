...
pipeline = Pipeline([
    ...
    ('clf', SGDClassifier(n_iter = 5, verbose =0, penalty = 'l2')),
])
#penalty = 'elasticnet'
parameters = {
    #'vect__max_df': (1.0),
