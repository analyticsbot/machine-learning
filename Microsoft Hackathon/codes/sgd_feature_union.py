...
parameters = {
    ...
    'union__title__tfidf__max_df': (0.8, 1),
    'union__title__tfidf__max_features': (5000,50000),
    'union__title__best__n_components': (5, 10, 20, 50),
    
    'union__summary__tfidf__norm': ('l1', 'l2'),
    'union__summary__tfidf__ngram_range': ((1,2), (1,3)),
    'union__summary__tfidf__max_df': (0.8, 1),
    'union__summary__tfidf__max_features': (5000,50000),
    'union__summary__best__n_components': (5, 10, 20, 50),

    'union__authors__countvec__n_components': (5, 10, 20, 50),
